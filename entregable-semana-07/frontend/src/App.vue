      ...
      <div class="login-card">
        ...
        <form v-if="authMode === 'register'" @submit.prevent="handleRegister">
          ...
          <p style="font-size: 0.72rem; color: var(--text-muted); margin-top: 10px; text-align: center; line-height: 1.3;">
            ...
            <a href="https://policies.google.com/terms" target="_blank" rel="noopener" style="color: var(--accent-color); text-decoration: underline;">Términos de Servicio</a> de Google.
          </p>
        </form>
...
export default {
  ...
  data() {
    return {
      ...
      // IA Backend de Tailo: se rutea por Express (/api/ai) para que este inyecte el header Bearer
      backendUrl: '/api/ai',
